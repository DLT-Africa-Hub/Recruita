...
import { getSkillsForPositions, rolesToPosition } from '../../../utils/material.utils';
            ...
            return (
              <button
                ...
                onClick={() => handleSelectSkill(skill)}
                  className={`flex items-center border rounded-xl py-2.5 px-4 transition-all duration-200 ${
                    isSelected
