...
const Header = () => {
  ...
  return (
    <div className='flex flex-col py-[15px] px-[20px] gap-[15px] sticky z-10 top-0 w-full border-b-[#00000033] text-[#1C1C1C] md:border-b md:pt-[68px] font-inter md:pb-[19px] md:px-[150px] bg-[#F9F9F9]'>
      ...
      <div className="w-full flex flex-col md:flex-row-reverse md:justify-between items-center ">
        <div className="flex w-full md:w-auto items-center  flex-wrap gap-5 ">
          <div className="flex items-center justify-center rounded-[10px] border border-[#C8D7EF] py-[15px] px-[26.5px] gap-[10px]">
